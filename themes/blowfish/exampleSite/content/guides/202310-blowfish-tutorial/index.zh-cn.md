...
执行完成后，尝试用下面的命令来运行你的网站。打开浏览器并访问 _[https://aloshdenny.github.io](https://aloshdenny.github.io)_ 即可查看你的网站。
...
打开 **config.toml** 并把 **theme = "blowfish”** 这一样的注释取消掉，目前为止你已经准备好了。再次尝试运行网站，并打开浏览器在_[https://aloshdenny.github.io](https://aloshdenny.github.io)_查看效果。
